# Epic Fantasy Political Strategy Game

This context names the player motives and political experience the design thesis is intended to support.

## Language

**Contest motive**:
A player's recurring desire for effective, consequential play and a credible contest. It may coexist with other motives and may change during play.
_Avoid_: Strategically optimizing player, optimizer, competitive player

**Relationship motive**:
A player's recurring desire for connection, mutual regard, and a worthwhile shared experience. It does not imply conflict avoidance and may coexist with other motives.
_Avoid_: Relationship-oriented player, social player, casual player

**Politics**:
Player-to-player attempts to shape choices under interdependence, including deals, persuasion, threats, coalition signals, votes, aid, and aggression. Table talk or conflict without meaningful mutual influence is not politics.

**Alliance**:
Conditional cooperation entered by each member as a means toward their own personal victory. It is not a permanent shared identity or a substitute team victory.
...
_Avoid_: Perfect optimization, win at all costs
